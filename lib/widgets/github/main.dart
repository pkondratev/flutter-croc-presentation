...
import 'package:flutter_presentation_croc/widgets/github/constants.dart';
import 'package:flutter_presentation_croc/widgets/github/data/contribution_data.dart';
import 'package:flutter_presentation_croc/widgets/github/data/data_series.dart';
import 'package:flutter_presentation_croc/widgets/github/data/stat_for_week.dart';
import 'package:flutter_presentation_croc/widgets/github/data/user_contribution.dart';
import 'package:flutter_presentation_croc/widgets/github/data/week_label.dart';
import 'package:flutter_presentation_croc/widgets/github/layered_chart.dart';
import 'package:flutter_presentation_croc/widgets/github/mathutils.dart';
import 'package:flutter_presentation_croc/widgets/github/timeline.dart';
...
//    weekLabels.add(WeekLabel.forDate(new DateTime(2018, 5, 7), "Beta 3"));
  ...
  Future loadGitHubData() async {
    String contributorsJsonStr =
        (await DefaultAssetBundle.of(context).loadString("assets/github_data/contributors.json"));
    ...
    String pullRequestActivityByWeekStr =
        (await DefaultAssetBundle.of(context).loadString("assets/github_data/pull_requests.tsv"));
